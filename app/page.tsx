  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            logo: 'https://dealwise.us/brand/dealwise-logo.svg',
      ...
      <div className="min-h-screen bg-white relative overflow-hidden">
        ...
        {/* What is DealWise? Section */}
        <div className="relative py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-brand-ink mb-4">What is DealWise?</h2>
              <div className="prose prose-lg max-w-none text-left text-brand-muted/90">
                <p className="text-lg leading-relaxed mb-4">
                  DealWise is a buyer-side assistant that helps car buyers prepare for dealership negotiations. 
                  We focus on written out-the-door (OTD) price calculations, identifying hidden dealer fees, 
                  and providing preparation tools before you visit the dealer.
                </p>
                <p className="text-lg leading-relaxed">
                  DealWise is not a marketplace or a generic chatbot. We provide specialized tools and guidance 
                  specifically designed for car buyers who want to negotiate with confidence and avoid common dealer tactics.
                </p>
              </div>
            </div>
          </div>
