...
CRITICAL: Return ALL required fields. Missing fields will cause an error.`,h=(t=`USER MESSAGE: "${a}"

`,d.dealerSaid&&(t+=`DEALER SAID: "${d.dealerSaid}"
`),d.inPersonSituation&&(t+=`CURRENT SITUATION: ${d.inPersonSituation}
`),d.desiredOTD&&(t+=`TARGET OTD: $${d.desiredOTD}
`),d.vehiclePrice&&(t+=`VEHICLE PRICE: $${d.vehiclePrice}
`),d.state&&(t+=`STATE: ${d.state}
`),d.ladder&&(t+=`NEGOTIATION LADDER:
- Ask: ${d.ladder.ask}
- Agree: ${d.ladder.agree}
- Walk: ${d.ladder.walk}
`),t+=`
...
Return ONLY valid JSON with ALL required fields.`),g=await u.chat.completions.create({model:"gpt-4o-mini",messages:[{role:"system",content:p},{role:"user",content:h}],response_format:{type:"json_object"},temperature:.7}),m=JSON.parse(g.choices[0].message.content||"{}"),f=["tactic","whatItMeans","sayThisNow","doNext","clarifyingQuestion","confidence"],y=f.filter(e=>"clarifyingQuestion"===e?!(e in m):!m[e]);if(y.length>0){console.warn("Advisor response missing fields:",y);let e=h+"\n\nCRITICAL: You must return ALL required fields: tactic, whatItMeans, sayThisNow, doNext, clarifyingQuestion (can be null), confidence (high|medium|low). Missing fields: "+y.join(", ");try{let t=await u.chat.completions.create({model:"gpt-4o-mini",messages:[{role:"system",content:p},{role:"user",content:e}],response_format:{type:"json_object"},temperature:.7}),s=JSON.parse(t.choices[0].message.content||"{}"),i=f.filter(e=>"clarifyingQuestion"===e?!(e in s):!s[e]);if(0!==i.length)return console.error("Advisor response still invalid after retry, using fallback"),o.NextResponse.json({success:!0,data:{tactic:"Unknown",whatItMeans:"Unable to analyze. Please provide more context.",sayThisNow:"I need a moment to review the numbers. Can you show me the itemized OTD breakdown?",doNext:"Request written OTD breakdown",clarifyingQuestion:"Can you paste what the dealer said, or describe the situation?",confidence:"low"}});Object.assign(m,s)}catch(e){return console.error("Retry failed, using fallback:",e),o.NextResponse.json({success:!0,data:{tactic:"Unknown",whatItMeans:"Unable to analyze. Please provide more context.",sayThisNow:"I need a moment to review the numbers. Can you show me the itemized OTD breakdown?",doNext:"Request written OTD breakdown",clarifyingQuestion:"Can you paste what the dealer said, or describe the situation?",confidence:"low"}})}}let I={tactic:String(m.tactic||"None").substring(0,100),whatItMeans:String(m.whatItMeans||"").substring(0,140),sayThisNow:String(m.sayThisNow||"").substring(0,300),doNext:String(m.doNext||"").substring(0,200),clarifyingQuestion:null===m.clarifyingQuestion||void 0===m.clarifyingQuestion?null:String(m.clarifyingQuestion).substring(0,200),confidence:["high","medium","low"].includes(m.confidence)?m.confidence:"medium"};return o.NextResponse.json({success:!0,data:I})}catch(e){return console.error("Error in in-person advisor:",e),o.NextResponse.json({success:!1,error:e.message||"Failed to get advisor response"},{status:500})}}let p=new r.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/in-person-advisor/route",pathname:"/api/in-person-advisor",filename:"route",bundlePath:"app/api/in-person-advisor/route"},resolvedPagePath:"C:\\dev\\Dealership Copilot\\app\\api\\in-person-advisor\\route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:h,staticGenerationAsyncStorage:g,serverHooks:m}=p,f="/api/in-person-advisor/route";function y(){return(0,a.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:g})}},19692:(e,t,s)=>{s.d(t,{$:()=>o,f:()=>c});var i=s(67721),r=s(71615);let n="https://vabikejehdmpfcyqrgrs.supabase.co",a="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZhYmlrZWplaGRtcGZjeXFyZ3JzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU0NzAzNDAsImV4cCI6MjA4MTA0NjM0MH0.X_Z7szu62swGviqYgtI2mxV3F1vX4UBYpuZYV2n7h4Q";if(!n||!a){let e=[];throw n||e.push("NEXT_PUBLIC_SUPABASE_URL"),a||e.push("NEXT_PUBLIC_SUPABASE_ANON_KEY"),Error(`[CRITICAL] Missing required Supabase environment variables: ${e.join(", ")}. These must be set in Vercel environment variables.`)}if(n.includes("placeholder")||a.includes("placeholder"))throw Error("[CRITICAL] Supabase environment variables contain placeholder values. Please set real values in Vercel environment variables.");if(n.length<10||a.length<10)throw Error("[CRITICAL] Supabase environment variables appear to be invalid (too short). Please verify they are set correctly in Vercel.");function o(){let e=(0,r.cookies)();return(0,i.createServerClient)("https://vabikejehdmpfcyqrgrs.supabase.co","eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZhYmlrZWplaGRtcGZjeXFyZ3JzIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU0NzAzNDAsImV4cCI6MjA4MTA0NjM0MH0.X_Z7szu62swGviqYgtI2mxV3F1vX4UBYpuZYV2n7h4Q",{cookies:{getAll:()=>e.getAll(),setAll(t){try{t.forEach(({name:t,value:s,options:i})=>{e.set(t,s,i)})}catch(e){}}}})}let c=o}};var t=require("../../../webpack-runtime.js");t.C(e);var s=e=>t(t.s=e),i=t.X(0,[8948,5972,7857,9702,4214],()=>s(81568));module.exports=i})();